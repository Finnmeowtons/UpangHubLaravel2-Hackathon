...
<head>
    ...
    <style>
        ...
        #main_progress_tab .receipt {
            ...
            padding: 20px;
            /* Adjust the padding to change the size of the container */
            border-radius: 10px;
            margin-bottom: 20px;
            width: 80%;
            /* Adjust the width to change the size of the container */
            margin: 0 auto;
                    ...
                    <div id="receipt_of_request_subtab">
                        ...
                        <div id="confirmation_message">
                            ...
                            <p id="confirmation_message_final">Your request has been submitted to the University
                                Registrar, Please constantly check the Progress tab to track your request. Thank you!
                            </p>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div id="serv_hover" class="room">
                                        <div class="order-info">
                                            <div class="order-number">OrderId #{{ $item->id }}</div>
                                            <div class="order-date">{{ $item->created_at }}</div>
                                        </div>
                                        <p>Good Moral: {{ $item->goodmoral }}</p>
                                        <p>Form 137: {{ $item->form }}</p>
                                        <p>Copy of grades: {{ $item->grade }}</p>
